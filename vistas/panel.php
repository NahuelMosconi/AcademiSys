...
<div class="tarjetas">
    <div class="tarjeta"><div class="ico-card ico-azul">📅</div><h3>Materias cursando</h3><p class="numero"><?= $misMaterias ?></p></div>
    <div class="tarjeta"><div class="ico-card ico-rojo">📄</div><h3>Notas registradas</h3><p class="numero"><?= $misNotas ?></p></div>
    <div class="tarjeta"><div class="ico-card ico-verde">✅</div><h3>Finales aprobados</h3><p class="numero"><?= $finales ?></p></div>
</div>
...
?>
<div class="tarjetas">
    <div class="tarjeta"><div class="ico-card ico-naranja">🏫</div><h3>Mis comisiones</h3><p class="numero"><?= $misComisiones ?></p></div>
    <div class="tarjeta"><div class="ico-card ico-azul">📚</div><h3>Mis materias</h3><p class="numero"><?= $misMaterias ?></p></div>
    <div class="tarjeta"><div class="ico-card ico-verde">🧑‍🎓</div><h3>Mis alumnos</h3><p class="numero"><?= $misAlumnos ?></p></div>
    <div class="tarjeta"><div class="ico-card ico-rojo">📄</div><h3>Notas (mis materias)</h3><p class="numero"><?= $notasCargadas ?></p></div>
</div>
<?php else:
...
?>
<div class="tarjetas">
    <div class="tarjeta"><div class="ico-card ico-azul">🧑‍🎓</div><h3>Alumnos activos</h3><p class="numero"><?= number_format($totalAlumnos,0,',','.') ?></p></div>
    <div class="tarjeta"><div class="ico-card ico-verde">📝</div><h3>Inscripciones activas</h3><p class="numero"><?= number_format($totalInsc,0,',','.') ?></p></div>
    <div class="tarjeta"><div class="ico-card ico-naranja">🏫</div><h3>Comisiones</h3><p class="numero"><?= number_format($totalCom,0,',','.') ?></p></div>
    <div class="tarjeta"><div class="ico-card ico-rojo">📄</div><h3>Notas registradas</h3><p class="numero"><?= number_format($totalActas,0,',','.') ?></p></div>
</div>
<?php endif; ?>
